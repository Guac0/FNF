...
_background ctrlSetPosition [0.25,-0.41,0.5,1.47]; //add 0.08 to last number for each new button
_background ctrlSetBackgroundColor [0,0,0,0.5];
_background ctrlCommit 0;

_essButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_essbutton ctrlSetPosition [0.275,0.03 - 0.41,0.45,0.05];
...
_mssButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08,0.45,0.05];
...
_pssButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 2,0.45,0.05];
...
_btwButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 3,0.45,0.05];
...
_rtwButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 4,0.45,0.05];
...
_btpButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 5,0.45,0.05];
...
_btmButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 6,0.45,0.05];
...
_rtpButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 7,0.45,0.05];
...
_rtmButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 8,0.45,0.05];
...
_emnButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 9,0.45,0.05];
...
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 10,0.45,0.05];
...
_weaponsButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 11,0.45,0.05];
_weaponsButton ctrlSetText ("Open Weapons GUI for OPFOR");
_weaponsButton buttonSetAction 'east call PHX_fnc_weaponListGUI;';
_weaponsButton ctrlCommit 0;

_weaponsButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 12,0.45,0.05];
...
_weaponsButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 13,0.45,0.05];
...
_weaponsButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 17,0.45,0.05];
...
_weaponsButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 18,0.45,0.05];
_weaponsButton ctrlSetText ("Open NVG GUI");
_weaponsButton buttonSetAction 'east call PHX_fnc_nvgGUI;';
_weaponsButton ctrlCommit 0;

_weaponsButton = (phx_adminGUI select 0) ctrlCreate ["RscButton", -1]; 
_weaponsButton ctrlSetPosition [0.275,0.03 - 0.41 + 0.08 * 19,0.45,0.05];
