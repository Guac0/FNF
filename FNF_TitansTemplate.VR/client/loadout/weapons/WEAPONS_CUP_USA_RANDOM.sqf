...
if (pRole == ROLE_AR || pRole == ROLE_MG) then {
  ...
  //phx_selector_weapons = [["CUP_lmg_M240_B","CUP_lmg_m249_pip2","CUP_lmg_M60E4_norail"]];
};
...
if (pRole == ROLE_MK) then {
  ...
  //phx_selector_weapons = [["CUP_srifle_Mk12SPR","CUP_srifle_m110_kac_black","CUP_srifle_M14_DMR","CUP_srifle_M2010_blk"]];
};
if (pRole == ROLE_CLS) then {
  phx_loadout_rifle_weapon = selectRandom ["CUP_sgun_M1014_vfg","CUP_smg_MP5A5_Rail_VFG","CUP_smg_MP7","CUP_arifle_Mk17_CQC_AFG","CUP_arifle_Colt727"];
  //phx_selector_weapons = [["CUP_sgun_M1014_vfg","CUP_smg_MP5A5_Rail_VFG","CUP_smg_MP7","CUP_arifle_Mk17_CQC_AFG","CUP_arifle_Colt727"]];
};
